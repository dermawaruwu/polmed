...
class MahasiswaController extends Controller
{
    ...
    /*Untuk mendapatkan username dan nama dari jurusan untuk dropdown */
    public function jurusanArray(){
        $jurusan = ArrayHelper::map(Jurusan::find()->all(), "id", "nama");
        return $jurusan;
    }
